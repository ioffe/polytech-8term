...
// In this context angle ABC is singular with precision 'eps' if:
// distance([AB], C) <= eps || distance([BC], A) <= eps

namespace impl
{
   template< class VertexBuffer, class ContoursIterator, class OutIterator >
      void check_singular_angles( VertexBuffer const &vertices,
                                  ...
                                  bool closed )
   {
      ...
      scalar_type const eps2 = cg::sqr(eps);
      ...
      for (ContoursIterator cIt = begin; cIt != end; ++cIt, ++cntIdx)
      {
         ...
         for (ContoursIterator::value_type::const_iterator vIt = cIt->begin(); vIt != cIt->end(); ++vIt)
         {
            ...
            if (closed)
            {
               ...
               if (eq_zero(distance_sqr(pointPrev, segment_2(pointCur, pointNext)), eps2) ||
                   eq_zero(distance_sqr(pointNext, segment_2(pointCur, pointPrev)), eps2))
                  found = true;
            }
   ...
   template< class VertexBuffer, class ContoursIterator, class OutIterator >
      void check_n_correct_singular_angles( VertexBuffer const &vertices,
                                            ContoursIterator begin, ContoursIterator end,
                                            OutIterator out,
                                            typename VertexBuffer::value_type::scalar_type eps,
                                            bool closed )
...
template< class VertexBuffer, class ContoursIterator, class OutIterator >
   void check_singular_angles( VertexBuffer const &vertices,
                               ...
                               OutIterator out )
{
   impl::check_singular_angles(vertices, begin, end, out, 
...
template< class VertexBuffer, class ContoursIterator, class OutIterator >
   void check_singular_angles( VertexBuffer const &vertices,
                               ...
                               typename VertexBuffer::value_type::scalar_type eps )
{
   impl::check_singular_angles(vertices, begin, end, out, eps, true);
}
...
template< class VertexBuffer, class ContoursIterator, class OutIterator >
   void check_n_correct_singular_angles( VertexBuffer const &vertices,
                                         ...
                                         OutIterator out )
{
   impl::check_n_correct_singular_angles(vertices, begin, end, out,
      cg::epsilon< VertexBuffer::value_type::scalar_type >(), true);
}
...
template< class VertexBuffer, class ContoursIterator, class OutIterator >
   void check_n_correct_singular_angles( VertexBuffer const &vertices,
                                         ...
                                         typename VertexBuffer::value_type::scalar_type eps )
{
   impl::check_n_correct_singular_angles(vertices, begin, end, out, eps, true);
}

template< class VertexBuffer, class PolylinesIterator, class OutIterator >
   void check_singular_angles_in_polyline( VertexBuffer const &vertices,
...
template< class VertexBuffer, class PolylinesIterator, class OutIterator >
   void check_singular_angles_in_polyline( VertexBuffer const &vertices,
                                            ...
                                            typename VertexBuffer::value_type::scalar_type eps )
{
   impl::check_singular_angles(vertices, begin, end, out, eps, false);
}

template< class VertexBuffer, class PolylinesIterator, class OutIterator >
   void check_n_correct_singular_angles_in_polyline( VertexBuffer const &vertices,
                                                     PolylinesIterator begin, PolylinesIterator end,
                                                     OutIterator out )
{
   impl::check_n_correct_singular_angles(vertices, begin, end, out,
...
template< class VertexBuffer, class PolylinesIterator, class OutIterator >
   void check_n_correct_singular_angles_in_polyline( VertexBuffer const &vertices,
                                                     ...
                                                     typename VertexBuffer::value_type::scalar_type eps )
{
   impl::check_n_correct_singular_angles(vertices, begin, end, out, eps, false);
}
